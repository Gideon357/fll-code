...
class Griffy(MoveDifferential):
    ...
    def medium_tank(inches, diameter, speed):
        inches/diameter = rotations
        medium_tank = MoveTank(LEFT_MEDIUM_MOTOR_PORT, RIGHT_MEDIUM_MOTOR_PORT, motor_class=MediumMotor)
        medium_tank.on_for_rotations(speed, speed, rotations)
