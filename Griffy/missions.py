...
class Missions(Griffy):
    ...
    def first_run(self):
        ...
        self.on_arc_left(
            SpeedPercent(-80), self.in_to_mm(4.8), self.in_to_mm(22)
        )  # Arc back into base
    ...
    def second_run(self):
        ...
        self.on_for_distance(
            SpeedPercent(25), 15
        )  # Go forward 15 inches to drop off the houses
        sleep(0.5)
        self.on_for_distance(
            SpeedPercent(-60), 14
        )  # Go backward at 100 power all of the way to the wall
        self.move_tank.on_for_rotations(100, -100, 0.63)  # Turn to the right 90 degrees
        self.on_for_distance(50, 19)  # Go to the Traffic Jam
        self.move_tank.on_for_rotations(
            100, -100, 0.3
        )  # Turn to the right and hit it up
        sleep(0.25)
        self.move_tank.on_for_rotations(
            -50, 50, 0.05
        )  # Turn to the right and hit it up
        self.on_for_distance(-100, 31)  # Go back home at 100 power
        self.move_tank.on_for_rotations(-100, 100, 0.62)  # Turn to the right
    ...
    def fourth_run(self):
        ...
        self.left_medium_motor.on_for_rotations(10, 0.34)
        self.on_for_distance(30, 2)
        self.attachment_tank.on_for_rotations(-8, 8, 0.2)
        self.on_for_distance(-50, 35)
        self.move_tank.on_for_rotations(-100, 100, 0.27)

    def fifth_run(self):
        """Treehouse: Aim"""
        self.on_for_distance(
            SpeedPercent(30), 23
        )  # Go forward 23 inches to the treehouse
        self.on_for_distance(
            SpeedPercent(15), 2
        )  # Drop in the cubes moving forward slowly
        self.on_for_distance(SpeedPercent(-10), 2.5)  # Slowly back away from tree
        self.on_for_distance(
            SpeedPercent(-100), 21.5
        )  # Go backwards 21.5 inches forcing the attachment off
        self.move_tank.on_for_rotations(25, -25, 0.25)  # Turn to the right
        ...
        self.move_tank.on_for_rotations(100, -100, 0.27)  # Turn right
    ...
    def sixth_run(self):
        ...
        self.on_for_distance(
            50, 60, use_gyro=True
        )  # Go forward 60 inches using the PID gyro algorthm
        self.move_tank.on_for_rotations(-8, 8, 0.2)  # Turn left
        self.move_tank.on_for_rotations(8, -8, 0.2)  # Turn right
        self.on_for_distance(-30, 12)  # Back up
        self.on_for_distance(30, 12)  # Go again to double check the swing
        self.on_for_distance(-30, 12)  # Back up
        self.move_tank.on_for_rotations(-8, 8, 0.225)  # Turn to elevator
        self.left_medium_motor.on_for_rotations(30, 0.56)  # Turn attachment
        self.on_for_distance(50, 11.5)  # Go and hit over evelator
        self.on_for_distance(-10, 12)  # Slowly back up
        self.move_tank.on_for_rotations(8, -8, 0.19)  # Turn right
        self.on_for_distance(-100, 50)  # Go home
        self.left_medium_motor.on_for_rotations(-30, 0.45)  # Turn attachment
    ...
    def seventh_run(self):
        ...
        self.move_tank.on_for_rotations(50, -50, 0.5)
    ...
    def eighth_run(self):
        ...
        self.line_square(20)  # Line square roughly
        self.line_square(20, which_algo="fine")  # Fine line square
        self.attachment_tank.on_for_rotations(10, -10, 0.34)
        self.on_for_distance(30, 5)  # Go forward 8 inches to drop off cubes
        self.on_for_distance(-20, 8)  # Back up
        self.line_square(20)  # Line square roughly
        self.line_square(20, which_algo="fine")  # Fine line square
        self.attachment_tank.on_for_rotations(-10, 10, 0.15)
        self.on_for_distance(20, 1.5)  # Go forward 1.5 inches
        self.move_tank.on_for_rotations(-15, 15, 0.53)  # Turn to the left
        self.left_large_motor.reset()
        self.on_for_distance(
            60, 24, use_gyro=True
        )  # Go 24 inches, getting up the bridge
        self.attachment_tank.on_for_rotations(10, -10, 0.1)
        self.move_tank.off()

    def nate_needs_help(self):
        while True:
            self.on_for_distance(15, 0.33)
            sleep(1.3)
            self.on_for_distance(-15, 0.3)
            sleep(1.3)
